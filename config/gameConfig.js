...
const GameConfig = {
    ...
    // Enemy spawning
    spawning: {
        baseSpawnInterval: 1.0,    // seconds
        minSpawnInterval: 0.3,     // fastest spawn rate
        spawnIntervalDecay: 0.98,  // Multiplier each wave

        bossInterval: 30,          // Spawn boss every 30 seconds

        difficultyIncreaseInterval: 10,  // Increase difficulty every 10s
        ...
        // Difficulty scaling
        enemyHpScaling: 0.3,       // 30% HP increase per difficulty level
